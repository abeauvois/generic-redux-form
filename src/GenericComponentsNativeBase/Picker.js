...
class PickerIOS extends React.Component{
	...
	render(){
		...
		var {onValueChange, selectedValue, children, ...props} = this.props;
		...
		return <select {...props} value={selectedValue} onChange={this._onChange} style={{borderColor: '#BDBDC1', borderWidth: 2}}>
			{options}
		</select>;
	}
}
